...
import { User, HeartThree, Cart, SearchTwo, Email } from "@svg/index";
    ...
    <>
      <header>
        <div className={`header__area ${style_2 ? "" : "header__transparent"}`}>
          <div className={`header__bottom-13 p-0 py-xxl-1 header__black-3 header__bottom-border-4 ${style_2 ? "header__bottom-13-white" : "bg-white"
            } header__sticky ${sticky ? "header-sticky" : ""}`} id="header-sticky" >
            <div className="container-fluid">
              <div className="row align-items-center headergizlici" style={{ backgroundColor: "#12173E" }}>
              ...
              <div className="mega-menu-wrapper p-relative">
                <div className="row align-items-center">
                  <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-4 col-1">
                    <div className="logo">
                      <Link href="/">
              ...
              <div className="row align-items-center d-none d-md-block" style={{ backgroundColor: "#dddddd" }}>
                <div className="main-menu main-menu-13 pl-45 main-menu-ff-space">
                  <nav id="mobile-menu-3" className="stt-menu-ust" style={{height:"50px"}}>
                    <Menus />
                  </nav>
                </div>
              </div>
